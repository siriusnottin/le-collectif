      ...
      {options.map(option => {
        ...
        return (
          <button
            key={option.id}
            onClick={handleClick}
            className={`relative overflow-hidden rounded-lg transition-all duration-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-collective-accent/50 ${
          ...
          >
            <div className="flex h-full flex-col gap-4 p-5 bg-white">
              ...
              <div className="space-y-1 text-left">
                <p className="font-serif text-base text-collective-bg tracking-tight">
                  {option.label}
                </p>
                <p className="font-mono text-xs uppercase text-collective-bg/70">
                  {option.color}
                </p>
                {rgbValue && (
                  <p className="font-sans text-[11px] uppercase tracking-[0.2em] text-collective-bg/45">
                    {rgbValue}
                  </p>
                )}
              </div>
